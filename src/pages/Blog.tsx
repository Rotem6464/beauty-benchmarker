  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto py-12 px-4">
        ...
        <p className="text-muted-foreground mb-8">Expert advice, reviews, and guides on lifting creams.</p>
        ...
        <div className="divide-y">
          {posts.map((post: any) => (
            <div key={post.sys.id} className="py-6">
              ...
              {post.fields.excerpt && (
                <p className="text-muted-foreground mt-2">{post.fields.excerpt}</p>
              )}
